  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <header className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Cards We're Buying</h1>
        <p className="text-gray-600">
          Browse our current buy prices for trading cards. Add cards to your cart for easier reference.
        </p>
      </header>
